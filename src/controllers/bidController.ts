...
export class BidController {
  public static makeBid(req: Request, res: Response): void {
    const { fleetId, rideRequestId, bidAmount } = req.body as Bid;
  ...
  public static viewBids(req: Request, res: Response): void {
  ...
  public static acceptBid(req: Request, res: Response): void {
